...
\begin{enumerate}
  ...
  \item[e-mail:]
    \href{mailto:folone@lambda-calcul.us}{folone@$\lambda$-calcul.us}
  ...
  \item[What I do every day:]
    \begin{list}{$\bullet$}{}
      \item state and prove theorems of formal constructivist logic (\href{http://en.wikibooks.org/wiki/Haskell/The_Curry-Howard_isomorphism}{proof});
    ...
    \item[Education:]
      \begin{list}{$\bullet$}{}
        ...
        \item National University of “Kyiv-Mohyla Academy”, 2010\newline
          ...
          Full-time, graduate (MS)\newline
          Thesis: “Design Patterns for Object-Oriented-Functional hybrid programming languages”\newline
      \end{list}

    \item[Tech skills:]
      \begin{list}{$\bullet$}{}
        \item[Scala (in production code)]
          \begin{list}{$\bullet$}{}
            \item Core
            \item Lift Framework
            \item Akka (1.x, 2.0.x, 2.1)
            \item scalaz (6.x, 7.0.0), contributed to the project
            \item specs2, scalacheck
            \item sbt, maven
          \end{list}
        \item[Scala (in personal/opensource projects)]
          \begin{list}{$\bullet$}{}
            \item Play2! framework
            \item spark, contributed to the project
            \item spray
          \end{list}
        \item[JS]
          \begin{list}{$\bullet$}{}
    ...
    \item[Tools, I’m used to:]
      \begin{list}{$\bullet$}{}
        ...
        \item emacs (my standard setup mainly consists of: evil-mode, scala2-mode
    ...
    \item[Work experience:]
      \begin{list}{$\bullet$}{}
        \item \href{http://deltamethod.com}{deltamethod GmbH} (01.2013 — present)\newline
          Position: Software Engineer\newline
          I'm developing a recommendation system for improving online
          ads/ad campaigns, using machine learning algorithms in python.\newline
          Tech: python, numpy, pandas, scikit-learn, pylab.
        \item \href{http://daxx.com/en}{Daxx} (04.2011 — 12.2012)\newline
