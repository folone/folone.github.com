...
\begin{enumerate}
  ...
  \item[What I do every day:]
    \begin{list}{$\bullet$}{}
      \item state and prove theorems of formal logic (\href{http://en.wikibooks.org/wiki/Haskell/The_Curry-Howard_isomorphism}{proof});
      ...
      \begin{list}{$\bullet$}{}
        ...
        \item[JS]
          \begin{list}{$\bullet$}{}
            ...
            \item have interest in ray, idris and agda js backends
          \end{list}
        \item[Java]
          \begin{list}{$\bullet$}{}
            \item Enterprise
