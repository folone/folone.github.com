...
\cventry{02.2014--present}{Backend Developer}{\href{http://soundcloud.com}{SoundCloud Inc.}}{Berlin}{}{}%
...
\cvitemwithcomment{\href{https://speakerdeck.com/folone/theres-a-prolog-in-your-scala}{There's a Prolog in your Scala!}}{Scala eXchange conference}{Scala is known to be a nice blend of object-oriented and functional paradigms. A lesser known fact is that it's also a logic programming language...in type system! This talk aims to shed some light on how Scala's type-level programming is essentially logic programming, and give reasoning for code, comprising 8+ implicit parameters with funny names (FnHipsterAux). After all, it's not the syntax, but rather the semantics we're after right?
...
\cvlistitem{do stuff for the Mathematics Inc.}
