...
\begin{enumerate}
  ...
  \item[Personal skills:]
    ...
    \item[Position, purpose:] Scala Developer.\newline
      Currently working (and willing to continue to work) on
      interesting Scala projects. Not interested in projects,
      involving any amount of Java coding (please do not contact me
      with such projects).
    ...
    \item[Tools, I’m used to:]
      \begin{list}{$\bullet$}{}
        \item Debian-based linux (prefer ubuntu due to the number of available software in repos);
    ...
    \item[Work experience:]
      \begin{list}{$\bullet$}{}
        \item \href{http://daxx.com/en}{Daxx} (04.2011 — present)\newline
          ...
          Tech: scala, liftweb, akka, dispatch, specs2, js.
