...
\cventry{01.2013--present}{Quantitative Developer}{\href{http://deltamethod.com}{deltamentod GmbH}}{Berlin}{}{Working on the backend for recommendation service.\newline{}%
  ...
  Tech: scala (saddle, scalaz, spire, scala-notebook, algebird), python (numpy, pandas, scikit-learn, pylab, ipython notebook)
Projects:\newline
\begin{list}{$\bullet$}{}
\item Westeros -- collection of algorithms that analyze text-based data for ad campaigns and make suggestions about adding keywords and negatives to campaigns/ad groups.
\item Adalyzer, Anna recommendations, and others -- collection of algorithms, working on numeric data to predict ad campaign success rates, analyze KPIs, predict structure, etc.
\end{list}}
...
\cventry{}{\href{https://github.com/scala/scala}{scala}}{\href{https://github.com/scala/scala/commits?author=folone}{List of contributions}}{}{Scala compiler and standard library}{Mostly minor fixes and improvements. Made a small contribution to the repl :kind feature of scala 2.11.}
...
\cvitemwithcomment{}{Scala}{
  \begin{list}{$\bullet$}{}
  \item Web framewors: Lift, play2!, spray
  \item Akka (1.x, 2.x)
  \item scalaz (6.x, 7.x), shapeless
  \item numeric libs/frameworks: spark, saddle, scala notebook, algebird
  \item testing: specs2, scalacheck
  \item building: sbt, maven
  \end{list}}
